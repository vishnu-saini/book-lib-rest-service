...
public class CategoryResource {
	...
	@RequestMapping(value = "/{categoryId}", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public RootResponse<Category> updateCategory(@PathVariable("categoryId") int categoryId,
